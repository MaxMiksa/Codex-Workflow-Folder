...
function patchWebviewBundleJs(source) {
  if (source.includes("CODEX_WORKFLOW_FOLD_PATCH_V13")) return source;
...
async function main() {
  ...
  results.push({
    ...
    verifyIncludes: "CODEX_WORKFLOW_FOLD_PATCH_V13",
  });
  if (zhCnJs) {
    results.push({
      file: zhCnJs,
