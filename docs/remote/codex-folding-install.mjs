...
function patchWebviewBundleJs(source) {
  if (source.includes("CODEX_WORKFLOW_FOLD_PATCH_V11")) return source;
...
async function main() {
  ...
  results.push({
    ...
    verifyIncludes: "CODEX_WORKFLOW_FOLD_PATCH_V11",
  });
  if (zhCnJs) {
    results.push({
      file: zhCnJs,
